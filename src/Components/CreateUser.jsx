...
const CreateUser = ({onClose}) => {
  ...
  const [user, setUser] = useState({ name: "", email: "", phone: "", username: "", suite: "", street: "", cname: "", catchphrase: "", bs: "",website:"",zipcode:"" });
  ...
  return (
    ...
    <div>
      ...
      <form className='w-[80vw]' onSubmit={handleSubmit}>
        ...
        <div className='flex'>
          <button type="submit" disabled={isCreating} className='bg-black w-full py-3 px-8 hover:bg-[#454545] text-lg font-semibold rounded-md text-white'>Create User</button>
        </div>
      </form>
    </div>
  )
